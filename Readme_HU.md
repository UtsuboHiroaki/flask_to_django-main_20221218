...
- django
  - models.py
    ...
    - もう1回urls.pyとviews.pyの教科書復習かな
      - 復習をしたら少し教科書に書いてあることが分かった
      - 検索にamazonの方が便利なら電子版も買いましょう
-株スクレイピング
  - 更新作業用にRetryのブランチを作成
- Copilot
  - Pycharmにインストール出来ました
- DeepLの設定がおかしくなりそちらを修正するのに苦労した

## 2023/1/6

- 12/29のフォローアップの動画を観たがaliceさんに比べると小生はまだまだだね
- djangoの独自プロジェクトを行う気はまだないもんね
- 帰りの電車でakiyokoさんの本をスマホで読んだ。まだまだ先行きは長そうだね
  - 電車で読める観点からは電子版もいいかもね

## 2023/1/7

- Edinetが繋がっていないので直し方不明です
- HTMLの方から直しました。直し方は競馬スクレイピングコードの小川先生の注釈に書いていました

## 2023/1/8

- コ－ドは少し直せた
  - 一番最後のfor文から関数かしたら見通しの悪さは減らせる

## 2023/1/9

- djangoは教科書を見てもまだ理解が進まない
- Read_HTML_V10.pyをリライトした報告してみる
- Splitの作業も出来ました

## 2023/1/10

- urls.pyに全部設定してあるんだね
  - 後の機能は階層が深すぎたりdjangoにもともとありそうなのでよく分からない
  - 角山さんの銘柄は今の私には魅力を感じなかった
  - EDINET_API_10.pyの改修はまだ出来ていない。不安すぎてcommit出来ない
...
- 小川さんから開催日時修正の案内はなかったけどこれでいいのだよね
- EdinetのAPIのリライトは一旦終了
- Read_HTML_V21.pyのリライトも一旦終了